...
func NewUniqueIdentifier(nonce []byte) protocol.ExtensionField {
	return protocol.ExtensionField{Type: protocol.UniqueIdentifier, Body: nonce}
}
...
func NewCookie(cookie []byte) protocol.ExtensionField {
	return protocol.ExtensionField{Type: protocol.NTSCookie, Body: cookie}
}
...
func NewCookiePlaceholder(targetLen int) protocol.ExtensionField {
	return protocol.ExtensionField{Type: protocol.NTSCookiePlaceholder, Body: make([]byte, targetLen)}
}
