...
func TestDecodeClientAccessesByIndex3(t *testing.T) {
	// Captured via `strace -xx -e trace=recvfrom chronyc clients` against a
	// chronyd serving real clients. Client IPs have been substituted with
	// RFC 5737 (192.0.2.0/24, 198.51.100.0/24, 203.0.113.0/24) and
	// RFC 3849 (2001:db8::/32) documentation ranges; all other fields
	// (hit counters, intervals, last-hit-ago sentinels) are unchanged.
	raw := []uint8{
		0x06, 0x02, 0x00, 0x00, 0x00, 0x44, 0x00, 0x15, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xa6, 0x18, 0xf1, 0xf7,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x10, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x08,
		...
		,
	}
	packet, err := decodePacket(raw)
	require.Nil(t, err)
	// chronyd uses 0x7f as an "interval unset" sentinel and 0xffffffff as
	// "never hit" for the *_hit_ago fields when the protocol wasn't used.
	want := &ReplyClientAccessesByIndex{
		ReplyHead: ReplyHead{
			Version:  protoVersionNumber,
			PKTType:  pktTypeCmdReply,
			Command:  reqClientAccessesByIndex3,
			Reply:    RpyClientAccessesByIndex3,
			Status:   sttSuccess,
			Sequence: 0xa618f1f7,
		},
		ClientAccessesByIndex: ClientAccessesByIndex{
			...
			Clients: []ClientAccess{
				{
					IPAddr:             &IPAddr{IP: IPToBytes(net.ParseIP("2001:db8::1")), Family: IPAddrInet6},
					NTPHits:            1,
					NTPInterval:        127,
					NKEInterval:        127,
					CmdInterval:        127,
					NTPTimeoutInterval: 127,
					LastNTPHitAgo:      447,
					LastNKEHitAgo:      0xffffffff,
					LastCmdHitAgo:      0xffffffff,
				},
				{
					IPAddr:             &IPAddr{IP: IPToBytes(net.ParseIP("192.0.2.1")), Family: IPAddrInet4},
					NTPHits:            1,
					NTPInterval:        127,
					NKEInterval:        127,
					CmdInterval:        127,
				...
				{
					IPAddr:             &IPAddr{IP: IPToBytes(net.ParseIP("192.0.2.2")), Family: IPAddrInet4},
					NTPHits:            1,
					NTPInterval:        127,
					NKEInterval:        127,
					CmdInterval:        127,
				...
				{
					IPAddr:             &IPAddr{IP: IPToBytes(net.ParseIP("198.51.100.3")), Family: IPAddrInet4},
					NTPHits:            2,
					NTPInterval:        6,
					NKEInterval:        127,
					CmdInterval:        127,
				...
				{
					IPAddr:             &IPAddr{IP: IPToBytes(net.ParseIP("198.51.100.4")), Family: IPAddrInet4},
					NTPHits:            1,
					NTPInterval:        127,
					NKEInterval:        127,
					CmdInterval:        127,
				...
				{
					IPAddr:             &IPAddr{IP: IPToBytes(net.ParseIP("203.0.113.5")), Family: IPAddrInet4},
					NTPHits:            7,
					NTPInterval:        8,
					NKEInterval:        127,
					CmdInterval:        127,
				...
				{
					IPAddr:             &IPAddr{IP: IPToBytes(net.ParseIP("203.0.113.6")), Family: IPAddrInet4},
					NTPHits:            3,
					NTPInterval:        -4,
					NKEInterval:        127,
					CmdInterval:        127,
				...
				{
					IPAddr:             &IPAddr{IP: IPToBytes(net.ParseIP("203.0.113.7")), Family: IPAddrInet4},
					NTPHits:            1,
					NTPInterval:        127,
					NKEInterval:        127,
					CmdInterval:        127,
...
func TestDecodeClientAccessesByIndex3Empty(t *testing.T) {
	head := []uint8{
		...
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		// NIndices=0, NextIndex=0, NClients=0
		0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00,
	}
	...
	packet, err := decodePacket(raw)
	require.Nil(t, err)
	rep, ok := packet.(*ReplyClientAccessesByIndex)
	require.True(t, ok)
	require.Equal(t, uint32(0), rep.NIndices)
	require.Equal(t, uint32(0), rep.NextIndex)
	require.Equal(t, uint32(0), rep.NClients)
	require.Empty(t, rep.Clients)
}

func TestEncodeClientAccessesByIndexPacket(t *testing.T) {
	p := NewClientAccessesByIndexPacket(0, MaxClientAccessesByIndex, 0)
	var buf bytes.Buffer
	require.NoError(t, binary.Write(&buf, binary.BigEndian, p))
	// chronyd's PKL_CommandLength requires 520 bytes for
	// REQ_CLIENT_ACCESSES_BY_INDEX3; smaller requests are rejected with
	// BADPKTLENGTH.
	require.Equal(t, 520, buf.Len())
	require.Equal(t, uint32(0), p.Reset)
	require.Equal(t, reqClientAccessesByIndex3, p.Command)

	p2 := NewClientAccessesByIndexPacket(8, MaxClientAccessesByIndex, 5)
	require.Equal(t, uint32(8), p2.FirstIndex)
	require.Equal(t, uint32(MaxClientAccessesByIndex), p2.NClients)
	require.Equal(t, uint32(5), p2.MinHits)
	require.Equal(t, uint32(0), p2.Reset)
}

func TestClientCommunicateClientAccessesByIndex(t *testing.T) {
	// Sanitized real chronyd reply (same bytes as TestDecodeClientAccessesByIndex3,
	// re-used here to exercise the full Client.Communicate read path including
	// the response buffer sizing.
	...
	rpy, err := client.Communicate(NewClientAccessesByIndexPacket(0, MaxClientAccessesByIndex, 0))
	require.NoError(t, err)
	r, ok := rpy.(*ReplyClientAccessesByIndex)
	require.True(t, ok)
	require.Equal(t, uint32(4096), r.NIndices)
	require.Equal(t, uint32(8), r.NextIndex)
	require.Equal(t, uint32(8), r.NClients)
	require.Len(t, r.Clients, 8)
	// Spot-check first and last entries
	require.Equal(t, IPAddrInet6, r.Clients[0].IPAddr.Family)
	require.Equal(t, uint32(1), r.Clients[0].NTPHits)
	require.Equal(t, IPAddrInet4, r.Clients[7].IPAddr.Family)
	require.Equal(t, "203.0.113.7", r.Clients[7].IPAddr.String())
}

func TestEncodeClientAccessesByIndexResetPacket(t *testing.T) {
	p := NewClientAccessesByIndexResetPacket(0, MaxClientAccessesByIndex, 0)
	var buf bytes.Buffer
	require.NoError(t, binary.Write(&buf, binary.BigEndian, p))
	require.Equal(t, 520, buf.Len())
	require.Equal(t, uint32(1), p.Reset)
	require.Equal(t, reqClientAccessesByIndex3, p.Command)
}
...
func TestPacketEncodingNoPanic(t *testing.T) {
	...
	// RequestClientAccessesByIndex has its own dedicated test
	// (TestEncodeClientAccessesByIndexPacket) because it exceeds the 500-byte
	// limit above: chronyd's anti-amplification padding pushes the request to
	// exactly 520 bytes.
}
...
func TestClientCommunicate(t *testing.T) {
	...
	testCases := []struct {
		...
		// RequestClientAccessesByIndex is covered by the dedicated
		// TestClientCommunicateClientAccessesByIndex test because its 520-byte
		// wire size exceeds the 500-byte sanity limit asserted below.
	}
...
func TestEORFieldInitialization(t *testing.T) {
	...
	packetsWithEOR := []struct {
		...
		{"RequestClientAccessesByIndex", NewClientAccessesByIndexPacket(0, MaxClientAccessesByIndex, 0)},
	}
	...
	for _, tt := range packetsWithEOR {
		t.Run(tt.name, func(t *testing.T) {
			...
			case *RequestSelectData:
				require.Equal(t, int32(0), p.EOR, "EOR should be initialized to 0")
			case *RequestClientAccessesByIndex:
				require.Equal(t, int32(0), p.EOR, "EOR should be initialized to 0")
			default:
