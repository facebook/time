...
// celesticaBoardIDs are revisions of the same Celestica timecard board.
// Hardcoded here because devlink does not surface a vendor-name field;
// widen this list as new board revisions appear in production.
var celesticaBoardIDs = []string{"R4006G000103", "R4006G000102"}
...
func classifyVendor(boardID string) string {
	switch {
	case boardID == oroliaBoardID:
		return VendorOrolia
	case slices.Contains(celesticaBoardIDs, boardID):
