...
ch7\ptp_synce\ntp\poll_log_interval=1 packet/16 s
ch6\ptp_synce\ptp\log_announce_int=1 packet/16 s
ch7\ptp_synce\ptp\log_announce_int=1 packet/16 s
ch6\ptp_synce\ptp\log_delay_req_int=1 packet/16 s
ch7\ptp_synce\ptp\log_delay_req_int=1 packet/16 s
ch6\ptp_synce\ptp\log_sync_int=1 packet/16 s
ch7\ptp_synce\ptp\log_sync_int=1 packet/16 s
